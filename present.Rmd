...
example1 <- readRDS("~/Documents/2020Fall/2036DS/projects-czang97/data/tdf_2020-11-17.1.rds")
example1 <- example1%>%
...
#### 1. Convert the `created_at` variable to date

```{r echo=FALSE, message=FALSE, warning=FALSE, paged.print=FALSE}
example1$created_at[1]
```
...
#### 3. Count the occurance of each token and identify the most frequent tokens.


#### 4. Exclude Stop words.
